...
class Transaction {
	...
	public String toString() {
		...
		str.append("{ reciever :").append(this.reciever).append(", type :").append(this.type).append(", amount :")
				.append(this.amount).append(", timestamp :").append(getDate()).append(" }");
		return str.toString();
	}
}

public class AltimetrikRound2_13June2022 {

	public Map<String, List<String>> groupTransactionsByDate(List<Transaction> transactions) {
		/*
		 * Complete this function which will group by the transactions on date where key
		 * will be the "date" and value will be the "List of stringified transactions"
		 */
	...
	public static void main(String[] args) {
		...
		list.add(t2);
		list.add(t3);
		AltimetrikRound2_13June2022 hw = new AltimetrikRound2_13June2022();
